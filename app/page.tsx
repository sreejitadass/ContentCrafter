      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Create engaging content for your blogs, articles and writeups with
            ...
            {[
              {
                ...
                icon: <PencilIcon className="w-10 h-10 mb-4 text-yellow-400" />,
                description:
                  "Generate well-researched and engaging blog articles that captivate your audience and drive traffic.",
              },
              {
                title: "News Campaigns",
                icon: <NewspaperIcon className="w-10 h-10 mb-4 text-red-500" />,
                description:
                  "Create impactful news campaigns that inform, engage, and resonate with your audience.",
              },
              {
                title: "Product and Marketing Content",
                icon: (
                  <ShoppingBagIcon className="w-10 h-10 mb-4 text-green-400" />
                ),
                description:
                  "Craft persuasive product and marketing content that highlights key features and drives conversions.",
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                ...
                "Stay ahead of trends with fresh content",
